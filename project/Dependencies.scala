...
object Dependencies {
  ...
  val scalaVersions = Seq("2.13.8", "3.0.0") // When updating these also update .travis.yml and appveyor.yml
  ...
  //TODO robstoll: scalaCollectionCompat was no longer in mainDependencies on dottyquery branch, remove again?
